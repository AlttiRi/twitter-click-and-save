...
<div class="ujs-btn-common ujs-btn-error-text"></div>`.slice(1);
        ...
        static async imagesHandler() {
            ...
            for (const img of images) {
                ...
                const isMobileVideo = img.src.includes("ext_tw_video_thumb") || img.closest(`a[aria-label="Embedded video"]`) || img.alt === "Animated Text GIF";
                if (isMobileVideo) {
...
function hoistAPI() {
    class API {
        ...
        static TweetDetailQueryId      = "q94uRCEn65LZThakYcPT6g"; // TweetDetail      (for videos)
        static UserByScreenNameQueryId = "SAMkL5y_N9pmahSw8yy6gw"; // UserByScreenName (for the direct user profile url)
